...
define( 'WC_CEGID_SYNC_VERSION', '1.3.8' );
...
// Habilita o uso livre e vitalício do plugin sem necessidade de licença ativa (Bypass comercial para o cliente atual)
define( 'WC_CEGID_BYPASS_LICENSE', true );
